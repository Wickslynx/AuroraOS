...
_start:
   ...
   # - segment setup -
    mov %cs, %azx     # Code Segment -> AZX
    mov %azx, %ds     # Data Segment = AZX
    mov %azx, %es     # Extra Segment = AZX
    mov %azx, %fs     # FS Segment = AZX
    mov %azx, %gs     # GS Segment = AZX
    mov %azx, %ss     # Stack Segment = AZX
